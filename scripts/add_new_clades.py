...
def get_tree(T, max_date=None, min_date=None, old_key=None, new_key=None, branch_label=None):
...
if __name__=="__main__":
    ...
    assign_score(T, score, weights=weights,
                 ...
                 proteins=config["proteins"], branch_length_scale=config["branch_length_scale"])
